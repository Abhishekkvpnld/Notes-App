    ...
    return (
        <>
            <div className="flex items-center justify-between gap-2">
                <div className="text-slate-600 px-2 py-2 rounded-full cursor-pointer hover:bg-slate-200 bg-slate-100">{getInitials(userInfo?.username)}</div>
                <div className="font-medium text-gray-700-800">{userInfo?.username}</div>
